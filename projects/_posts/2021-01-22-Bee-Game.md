...
![Bee Game's Logo](/images/projects/Bee_Game/logo.png)  
...
![An early concept for Bee Game from well before development](/images/projects/Bee_Game/early_concept.png)
...
![Spritework for the original group of 6 bugs](/images/projects/Bee_Game/bugs.png)  
...
![Gameplay from an early build using the concept assets](/images/projects/Bee_Game/early_build_gameplay_people.gif)  
![Gameplay from an early build using the new placement UI and bug assets](/images/projects/Bee_Game/early_build_gameplay_bugs.gif)
...
![An angry bee with a honeycomb shield](/images/projects/Bee_Game/bee_shield.png)  
...
![An angry, perfectly normal bee](/images/projects/Bee_Game/bee_normal.png)  
Second, our normal bee from before, I believe mostly unchanged.  

![A happy bee on a flower](/images/projects/Bee_Game/bee_flower.png)  
...
![A angry, perfectly red bee](/images/projects/Bee_Game/bee_red.png)  
...
![A regal queen bee](/images/projects/Bee_Game/bee_queen.png)  
...
![A cool bee with two guns](/images/projects/Bee_Game/bee_gun.png)  
...
![The projectiles the bees shoot](/images/projects/Bee_Game/projectiles.png)  
...
![All 9 sprites the flower timer rotates through and the honeypot it gives you](/images/projects/Bee_Game/flower_timer_and_honeypot.png)    
...
![Gameplay of a late build featuring almost all of the game systems](/images/projects/Bee_Game/late_build_gameplay.gif)  
...
![The instructions seen in the game](/images/projects/Bee_Game/instructions.png)  
![The final version of the game](/images/projects/Bee_Game/final_build_gameplay.gif)  
...
Finally, I can't end off a write-up about a game without including a download link! You can find it [here](/downloads/projects/Bee_Game/Bee_Game_Executables.zip). Let me know what you think, and thanks for getting this far if you made it all the way through.  

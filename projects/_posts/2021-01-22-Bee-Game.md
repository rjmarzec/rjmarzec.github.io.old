...
![Bee Game's Logo](/assets/images/projects/Bee_Game/logo.png)  
...
![An early concept for Bee Game from well before development](/assets/images/projects/Bee_Game/early_concept.png)
...
![Spritework for the original group of 6 bugs](/assets/images/projects/Bee_Game/bugs.png)  
...
![Gameplay from an early build using the concept assets](/assets/images/projects/Bee_Game/early_build_gameplay_people.gif)  
![Gameplay from an early build using the new placement UI and bug assets](/assets/images/projects/Bee_Game/early_build_gameplay_bugs.gif)
...
![An angry bee with a honeycomb shield](/assets/images/projects/Bee_Game/bee_shield.png)  
...
![An angry, perfectly normal bee](/assets/images/projects/Bee_Game/bee_normal.png)  
Second, our normal bee from before, I believe mostly unchanged.  

![A happy bee on a flower](/assets/images/projects/Bee_Game/bee_flower.png)  
...
![A angry, perfectly red bee](/assets/images/projects/Bee_Game/bee_red.png)  
...
![A regal queen bee](/assets/images/projects/Bee_Game/bee_queen.png)  
...
![A cool bee with two guns](/assets/images/projects/Bee_Game/bee_gun.png)  
...
![The projectiles the bees shoot](/assets/images/projects/Bee_Game/projectiles.png)  
...
![All 9 sprites the flower timer rotates through and the honeypot it gives you](/assets/images/projects/Bee_Game/flower_timer_and_honeypot.png)    
...
![Gameplay of a late build featuring almost all of the game systems](/assets/images/projects/Bee_Game/late_build_gameplay.gif)  
...
![The instructions seen in the game](/assets/images/projects/Bee_Game/instructions.png)  
![The final version of the game](/assets/images/projects/Bee_Game/final_build_gameplay.gif)  
...
Finally, I can't end off a write-up about a game without including a download link! You can find it [here](assets/downloads/projects/Bee_Game/Bee_Game_Executables.zip). Let me know what you think, and thanks for getting this far if you made it all the way through.  
